<template>
  <div class="flex flex-col gap-6 mt-6">
      ...
      <div class="flex flex-col gap-4">
        ...
        <div class="flex flex-col gap-3">
          <div 
            ...
            class="p-4 rounded-xl border-border border-2 border-b-[6px] bg-surface shadow-sm cursor-grab active:cursor-grabbing hover:border-primary/50 text-maintext transition-all text-center font-bold active:translate-y-0.5 active:border-b-2"
    ...
    <button 
      ...
      :class="isAllMatched ? 'bg-primary hover:bg-primary/95 hover:shadow-lg hover:shadow-primary/30 transform hover:-translate-y-0.5' : 'bg-slate-300 cursor-not-allowed'"
    >
      تحقق من الإجابة
    </button>
  </div>
